...
var __slice = [].slice;
  ...
  StorageFreak = (function() {
    ...
    StorageFreak.prototype._regexEscape = function(string) {
...
var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
  ...
  Selectorablium = (function() {
    ...
    Selectorablium.prototype.reset = function() {
      this._insertOptionElement(this.config.default_value, this.config.default_text);
    ...
    Selectorablium.prototype._regexEscape = function(string) {
      return string.replace(/[-[\]{}()*+!<=:?.\/\\^$|#\s,]/g, '\\$&');
    };
